# This is a Makefile for doing various tests related to brainnets, like
...
# Run tests
test:
	$(PYTHON) `which nosetests` ./tests/ $(NOSE_HTML)

# Generate all docs
docs:
	mkdir -p docs/
	$(PYTHON) docs/apidoc.py ../brainnets/ -o ./docs/api/ -f -d 0 --separate \
...
coverage:
	...
	--with-coverage ../brainnets/tests/ \
	--cover-erase --cover-package=brainnets \
